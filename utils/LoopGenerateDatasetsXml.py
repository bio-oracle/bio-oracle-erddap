...
if __name__ == "__main__":
    ...
    parser.add_argument("--layer-name-from", help="Whether to use the layer name from the filename or from the parent directory.", choices=["filename", "parent"], default="parent", required=False)
